...
parser.add_argument('-m', '--trained_model', default='./model_data/mobilenet0.25_Final.pth',
...
#   facenet所使用到的输入图片大小
# ----------------------------------------------------------------------#
facenet_input_shape = np.array([160, 160, 3])
...
def detect_image(img, net, device, cfg):
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # 检查r_image是否为空
        if r_image is not None and r_image.size > 0:
            # 显示结果
